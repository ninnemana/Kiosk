...
- (void)viewDidLoad
{
    ...
    [scrollView setBackgroundColor:[self colorWithHexString:@"d6d3d1"]];
    ...
    for(i = 0; i < [cartItems count]; i++){
        ...
        border.backgroundColor = [self colorWithHexString:@"efeeed"];
        ...
        [bottomBorder setBackgroundColor:[self colorWithHexString:@"efeeed"]];
    ...
    [topSectionBorder setBackgroundColor:[self colorWithHexString:@"efeeed"]];
...
- (void)deleteCartItem:(id)sender{
    ...
    delegate.cartItems = [[NSMutableDictionary alloc] initWithDictionary:remainingItems];
    [cartItems release];
